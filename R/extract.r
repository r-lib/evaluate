#' Extract output from an evaluation.
#' 
#' This function helps extracting certain output types (e.g. graphics or messages) from an evaluation object
#' that has been returned by evaluate()
#' 
#' @param evaluation object returned by evaluate()
#' @param what type of output to extract. Must be string.
#' @export
